...
namespace RainbowSchoolWebAPI.Controllers
{
    ...
    {
        private readonly RainbowSchoolDataDbContext _context;

        public SubjectsController(RainbowSchoolDataDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Subjects>> PostSubjects(Subjects subjects)
        {
          if (_context.Subjects == null)
          {
              return Problem("Entity set 'RainbowSchoolDataDbContext.Subjects'  is null.");
          }
